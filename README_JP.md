...
| `ccexp.viewMode` | 各 Project/User グループ内で `flat` または `tree` 表示を切り替え | `flat` |
...
| スキル | `.claude/skills/**/SKILL.md` | `~/.claude/skills/**/SKILL.md` |
